...
import 'package:start_tech_test/src/core/dio/error_model.dart';
import 'package:start_tech_test/src/core/log/logger.dart';
import 'package:start_tech_test/src/core/internet/internet_info.dart';
import 'package:start_tech_test/src/utils/consts.dart';

class DioClient {
  final InternetInfo _internetInfo = InternetInfoImpl();
  final String _devBaseURL = "http://testapi.alifouad91.com/";
  ...
  String? _errorFunc(error) {
    ...
    Constants.dialogMessage(description: err.message);
    return err.message;
  }
